            ...
            for ($i = 0; $i < sizeof($usr_cart); $i++) : ?>
                <tr>
                    ...
                    <td>
                        ...
                        <button type="submit" class="custom-grid-btn add-to-cart" id="addToCart_<?php echo $i; ?>">
                    ...
                    <td>
                        <button type="submit" class="custom-grid-btn remove-from-cart" id="removeFromCart_<?php echo $i; ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 16 16">
